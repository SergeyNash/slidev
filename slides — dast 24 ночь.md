...
<div class="center-xy">
  ...
  >
    ...
    <span class="badge accent">DevSecOps</span>
    <span class="badge warning">WebSecurity</span>
  </div>
</div>
...
<div class="panel">
  <div class="status warning">сдвиг</div>
...
<div class="cyber-columns">
  <div class="cyber-col cyber-col--sast">
    <div class="hero-line" style="font-size: 1em; margin-bottom: 0.5rem;">SAST</div>
    <p>«может быть проблема»</p>
  </div>
  <div class="cyber-col cyber-col--dast">
    <div class="hero-line" style="font-size: 1em; margin-bottom: 0.5rem;">DAST</div>
    <p>«вот как это ломается»</p>
  </div>
</div>

<div class="panel" style="margin-top: 0.75rem;">
  <div class="status active">экономика</div>
  <div class="hero-line">подтверждённые находки >> меньше шума и triage >> ниже стоимость исправления</div>
</div>
...
<div class="panel">
  <div class="status active">фокус</div>
  <div class="hero-line">не объём отчёта, а значимость для атакующего</div>
  <div class="signal-list">
    <div class="signal">
      <div class="signal-label">вопрос</div>
      <div class="signal-value">не «есть ли проблема», а <strong>«можно ли атаковать»</strong></div>
    </div>
    <div class="signal">
      <div class="signal-label">приоритет</div>
      <div class="signal-value">фокус на <strong>значимости</strong>, а не на объёме «найденного»</div>
    </div>
  </div>
</div>
...
<div class="panel-bento">
  <div class="panel panel-compact">
    ...
    <p><strong>Плюсы:</strong> полный контроль HTTP, гибкость атак, быстрый feedback</p>
    <p><strong>Минусы:</strong> нужна экспертиза, плохо масштабируется</p>
  </div>
  <div class="panel panel-compact">
    <div class="status accent">автоматизированный</div>
    <div class="hero-line">масштаб</div>
    <p><strong>Плюсы:</strong> масштаб, регулярность, автоматизация</p>
    <p><strong>Минусы:</strong> слабый контекст, типичные проблемы с auth, меньше гибкости</p>
  </div>
  <div class="panel panel-compact panel-bento-full">
    <div class="status warning">CI/CD</div>
    <div class="hero-line">в pipeline</div>
    <p><strong>Плюсы:</strong> в pipeline, проверка на релизах, автоматические gate</p>
    <p><strong>Риск:</strong> шум и нестабильность >> <strong>выключают</strong> сканер</p>
  </div>
</div>
...
<div class="panel">
  ...
  <div class="hero-line">ручной >> точность · авто >> масштаб · CI/CD >> процесс</div>
  <div class="callout callout--key">
    <p>нужен <strong>баланс</strong>, а не «один правильный режим»</p>
  </div>
</div>
...
<div class="panel">
  ...
  <div class="hero-line">боль внедрения убивает инструмент</div>
  <div class="signal-list">
    <div class="signal">
      <div class="signal-label">внедрение</div>
      <div class="signal-value">долго, сложно настроить, ломает pipeline >> <strong>отключают</strong></div>
    </div>
    <div class="signal">
      <div class="signal-label">итог</div>
      <div class="signal-value">шум вместо сигналов, отчёты без действий, потеря доверия</div>
    </div>
  </div>
</div>
...
<div class="panel">
  ...
  <div class="signal-list">
    <div class="signal">
      ...
      <div class="signal-value">ручной (как Burp), автоматический, CI/CD — <strong>один инструмент</strong>, без потери смысла</div>
    </div>
  </div>
  <div class="hero-line">покрытие: стек, API и OAST</div>
  <div class="signal-list">
    <div class="signal">
    ...
    <div class="signal">
      ...
      <div class="signal-value">широкий охват <strong>CWE</strong>, активные проверки, <strong>OAST</strong> для blind — не сводить к «топ-10»</div>
    </div>
  </div>
  <div class="hero-line">прозрачность</div>
  <div class="signal-list">
    <div class="signal">
...
<div class="panel">
  <div class="status active">от ноутбука до enterprise</div>
  <div class="signal-list">
    <div class="signal">
      <div class="signal-label">deploy</div>
      <div class="signal-value">CLI без лишней инфраструктуры, облако, Kubernetes / autoscale</div>
    </div>
    <div class="signal">
      <div class="signal-label">enterprise</div>
      <div class="signal-value">RBAC, аудит и логирование, backup / restore >> один продукт от разработчика до кластера</div>
    </div>
  </div>
  ...
  <div class="signal-list">
    <div class="signal">
      <div class="signal-label">API</div>
      <div class="signal-value">открытый <strong>API</strong>, webhooks, кастомизация под <strong>ваш</strong> процесс</div>
    </div>
  </div>
  ...
  <div class="signal-list">
    <div class="signal">
      ...
      <div class="signal-value">максимум деталей, «почему», <strong>воспроизводимость</strong> >> доверие разработчиков</div>
    </div>
  </div>
</div>
...
<div class="panel">
  ...
  <div class="signal-list">
    <div class="signal">
      <div class="signal-label">цитата</div>
      <div class="signal-value">«Сканер почти <strong>ничего</strong> не находит»</div>
    </div>
    <div class="signal">
      <div class="signal-label">архитектура</div>
      <div class="signal-value"><strong>SPA</strong>, логика за <strong>API</strong> и сканер на фронте >> <strong>backend почти не виден</strong></div>
    </div>
    <div class="signal">
      <div class="signal-label">схема</div>
      <div class="signal-value"><strong>нет OpenAPI</strong> — клиент не знает, где взять контракт</div>
    </div>
  </div>
  <div class="callout">
    <p><strong>Диалог:</strong> «Загрузите API-схему» >> «<strong>Где её взять? У нас нет</strong>»</p>
    <p class="small" style="margin: 0.35rem 0 0;">типичный <strong>enterprise</strong>, не исключение</p>
  </div>
  <div class="note"><strong>Инсайт:</strong> не «плохо ищет», а  <strong>неизвестно, где искать</strong></div>
</div>
...
<div
  ...
  :enter="{ opacity: 1, y: 0, transition: { type: 'spring', stiffness: 280, damping: 26, delay: 80 } }"
>
  <div class="status accent">раздел</div>
...
# Проблема №1 - Одинаковая страница или разная?

<div class="stack">
  <div class="panel">
    <div class="status warning">проблема</div>
    <div class="hero-line">как отличить состояние</div>
    <div class="signal-list">
      <div class="signal">
        <div class="signal-label">URL</div>
        <div class="signal-value">не надёжен: разные страницы >> один адрес</div>
      </div>
      <div class="signal">
        <div class="signal-label">HTML / текст</div>
        <div class="signal-value">посимвольно бесполезно >> шум от рандома при каждой загрузке</div>
      </div>
      <div class="signal">
        <div class="signal-label">нечёткое сравнение</div>
        <div class="signal-value">может «склеить» страницы, отличающиеся одним атрибутом (напр. <code>hidden</code>)</div>
      </div>
      <div class="signal">
        <div class="signal-label">скриншоты</div>
        <div class="signal-value">дорого и тяжело масштабировать</div>
      </div>
      <div class="signal">
        <div class="signal-label">шаблоны</div>
        <div class="signal-value">товар / статья / пользователь >> разный контент, одна «форма» >> важно посетить класс <strong>один раз</strong></div>
      </div>
      <div class="signal">
        <div class="signal-label">риск</div>
        <div class="signal-value">всё «новое» >> бесконечный краулинг · всё «то же» >> низкое покрытие</div>
      </div>
    </div>
  </div>
  <div class="panel">
    <div class="status active">решение</div>
    <div class="hero-line">якорь состояния</div>
    <div class="signal-list">
      <div class="signal">
        <div class="signal-label">идея</div>
        <div class="signal-value">не цепляться только к URL, сырому HTML и тексту >> собрать <strong>набор якорей</strong>, уникальных для состояния</div>
      </div>
      <div class="signal">
        <div class="signal-label">алгоритм</div>
        <div class="signal-value">на странице A >> набор якорей · на B >> свой набор · <strong>различаются</strong> >> разные состояния</div>
      </div>
      <div class="signal">
        <div class="signal-label">ключевое</div>
        <div class="signal-value">что именно считать якорем >> от этого зависит качество дедупликации</div>
      </div>
      <div class="signal">
        <div class="signal-label">скрипты</div>
        <div class="signal-value">набор скриптов как сигнал >> слабо для «классики», боль с <strong>inline</strong></div>
      </div>
      <div class="signal">
        <div class="signal-label">все элементы</div>
        <div class="signal-value">лучше, но избыточно >> не каждый <code>&lt;span&gt;</code> важен для идентификации</div>
      </div>
      <div class="signal">
        <div class="signal-label">практика</div>
        <div class="signal-value">комбинации и <strong>фильтры</strong> якорей >> не все скрипты/узлы, только удовлетворяющие правилам</div>
      </div>
    </div>
  </div>
</div>
...
<!--
Проблема дедупликации при краулинге: URL не отражает состояние; точное сравнение HTML даёт шум; нечёткое — теряет тонкие различия; скриншоты дороги; нужно понимать эквивалентность шаблонных страниц и посещать представителя один раз — иначе либо вечный краулинг, либо дырявое покрытие.

Решение: фиксировать состояние набором якорей на странице и сравнивать наборы; критичен выбор якорей (скрипты, DOM — с компромиссами); на практике — смешанные эвристики и фильтрация кандидатов.
-->
...
<div class="panel">
  <div class="status accent">эволюция</div>
  <div class="signal-list">
    <div class="signal">
      <div class="signal-label">проблема</div>
      <div class="signal-value">ручное описание · хрупкость</div>
    </div>
    <div class="signal">
      <div class="signal-label">реальность</div>
      <div class="signal-value">SSO / OAuth / сложные flow</div>
    </div>
    <div class="signal">
      <div class="signal-label">эволюция</div>
      <div class="signal-value">запись действий · replay</div>
    </div>
    <div class="signal">
      <div class="signal-label">вызовы</div>
      <div class="signal-value">стабильность сценариев · токены / сессии</div>
    </div>
  </div>
  <div class="note">>> auth = сценарий</div>
</div>
...
<div class="grid-2-even">
  <div class="panel">
    ...
    <div class="hero-line">эволюция</div>
    <div class="signal-list">
      <div class="signal">
  ...
  <div class="panel">
    <div class="status accent">инженерия</div>
    <div class="hero-line">задачи</div>
    <div class="signal-list">
      <div class="signal">
        <div class="signal-label">форматы</div>
        <div class="signal-value">унификация: Selenium, Chrome Recorder и др.</div>
      </div>
      <div class="signal">
        <div class="signal-label">стабильность</div>
        <div class="signal-value">сценариев при изменении UI</div>
      </div>
      <div class="signal">
        <div class="signal-label">Работа</div>
        <div class="signal-value">с токенами и сессиями</div>
      </div>
    </div>
  </div>
</div>
...
<!--
Ответ на слайд «Аутентификация»: запись реального входа в браузере и replay вместо описания полей. Практика — свести форматы (Selenium, Chrome Recorder), держать сценарии живыми при смене UI, корректно жить с токенами и сессиями. Инсайт дублирует и усиливает мысль: auth моделируется как сценарий, а не как статическая форма.
-->
