...
<p class="slide-modes-balance-line">
  Вывод: нужен <strong>баланс</strong>, а не «один правильный режим»
</p>
...
<div class="panel">
  ...
  <div class="hero-line">если с инструментом тяжело жить, его выключают</div>
  <div class="signal-list">
    <div class="signal">
